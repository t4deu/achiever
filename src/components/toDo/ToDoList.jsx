...
export default class ToDoList extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      amountUndoneToDos:
        amountUndoneToDosSaved === true ? amountUndoneToDos : '0',
  ...
  showCheckbox(toDoDone) {
    if (toDoDone) {
      return <img className="toDo-checkbox" src="assets/images002-check.svg" />;
    }
    return (
      <img
        className="toDo-checkbox"
        src="assets/images001-check-box-empty.svg"
      />
    );
  }
  ...
  showDeleteButton() {
    return (
      <div className="deleteButton-todoList">
        <img
          className="letterX-todoList"
          src="assets/images002-remove-symbol.svg"
        />
      </div>
    );
  }
  ...
  deleteTodo(todoId) {
    const updatedToDosArr = removeFromLocalStorageArray(
      'toDosArr',
      'id',
      todoId
    );
  ...
  render() {
    return (
      <div className="todo-list-container">
        <div className="todo-icon" onClick={this.toggleModal.bind(this)}>
          <img className="todolist-check" src="assets/images002-check.svg" />
          {this.state.todo}
        </div>
